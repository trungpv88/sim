...
class ServerDialog(wx.Dialog):
    ...
    def __init__(self, parent, title):
        wx.Dialog.__init__(self, parent, wx.ID_ANY, title,  size=(450, 150))
        self.dialog_design()
        self.ShowModal()
    ...
    def dialog_design(self):
        ...
        server_sizer.Add(word_definition_server, 1, wx.EXPAND | wx.ALL, 10)
        server_sizer.Add(word_pronunciation_server, 1, wx.EXPAND | wx.ALL, 10)
        server_sizer.Add(description_image_server, 1, wx.EXPAND | wx.ALL, 10)
    ...
    def create_server_config(self, name, text):
        ...
        server_label = wx.StaticText(self, -1, name, size=(110, 20))
